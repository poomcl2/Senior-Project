    ...
    <div class="parent">
      ...
      <div class="container-fluid">
        ...
        <b-row>
          <b-col sm="6" lg="2">
            <b-row>
              <b-card no-body class="bg-poom border-dark" style="max-width: 400px; text-white;">
                <b-card-body class="pb-8">
                  <b-dropdown class="float-right" variant="transparent p-0" right>
                    <template slot="button-content">
                      <i class="icon-settings"></i>
                    </template>
                    <b-dropdown-item>Last 7 Hours</b-dropdown-item>
                    <b-dropdown-item>Last 7 Days</b-dropdown-item>
                    <b-dropdown-item disabled>Future Function</b-dropdown-item>
                  </b-dropdown>
                  <h2 class="mb-0">58,412 Tweets</h2>
                  <p>In Last 7 Hours</p>
                </b-card-body>
          ...
          <b-col sm="6" lg="7">
            <!-- CARD STYLE -->
            <div class="card text-white bg-mycarddark mb-3" style="max-width: 70rem;">
              ...
              <b-card-body class="card-bodyme" style="max-height: 33rem;">
                <b-row>
                  <!-- Async Component -->
                  ...
                  >
                    ...
                    <template
                      v-slot:default="{ pending, error, data, data2, data3, data4, data5, SentiScore, prob }"
                    >
                      <!-- Request Pending -->
                        ...
                        <b-row>
                          ...
                          <b-col sm="6" lg="6">
                              ...
                              <b-col sm="6" lg="6">
                                <div class="card" style="width: 13rem;">
                                  <div class="card-body">
                                    ...
                                    <small class="text-muted text-uppercase font-weight-bold">Tweets</small>
                                  </div>
                                </div>
                              </b-col>
                              ...
                              <b-col sm="6" lg="6">
                                ...
                                >
                                  <div class="card-body">
                                    ...
                                    <div class="text-value-lg"><b>{{ SentiScore }} / 10</b></div>
                                    <small
                            ...
                            <b-row>
                              ...
                              <b-col sm="6" lg="6">
                                <div class="card" style="width: 13rem; height: 9rem;">
                                  <div class="card-body">
                                    <!-- <div class="text-muted text-right mb-4">
                                      <i class="fa fa-fire"></i>
                                    </div>-->
                                    <div class="text-value-lg"><b>0 / 10</b></div>
                                    <small
                                      class="text-muted text-uppercase font-weight-bold"
                            ...
                            <b-row>
                              ...
                              <b-col sm="6" lg="6">
                                ...
                                >
                                  <div class="card-body">
                                    <div class="text-value-lg"><b>{{prob}}%</b></div>
                                    <small
                                      class="text-muted text-uppercase font-weight-bold"
          ...
          <b-col sm="6" lg="3">
            <b-card
              bg-variant="poom"
              style="width: 400px; height: 36rem; bg-primary text-white"
              id="norightmargin"
            >
                    ...
                    <td colspan="6">
                      <div>
                        <p align="right" style="color:green;">
                          <b v-if="trend.Operator == '+' "
                            style="color:green;"
                          >{{trend.Operator}}{{ trend.Change.toLocaleString() }}</b>
                          <b v-else-if="trend.Operator == '-' "
                            style="color:red;"
                          >{{trend.Operator}}{{ trend.Change.toLocaleString() }}</b>
                        </p>

                        <p align="right">Total: {{ trend.TweetVol.toLocaleString() }}</p>
                      </div>
                    </td>
                  </tr>
                </tbody>
        ...
        <b-row>
          ...
          <b-col sm="6" lg="3">
            <b-card
              bg-variant="poom"
              style="width: 400px; bg-primary text-white"
              id="norightmargin"
            >
              <!-- <div v-if="loading" class="loading">Loading...</div> -->
              <table
              ...
              >
                ...
                <tbody>
                  <tr :key="trend.Trends" v-for="(trend) in topTrends">
                    ...
                    <td colspan="6">
                      <div>
                        <p align="right" style="color:orange;">{{ trend.Change.toLocaleString() }}</p>
                        <p align="right">Total: {{ trend.TweetVol.toLocaleString() }}</p>
                      </div>
                    </td>
                  </tr>
...
export default {
  ...
  beforeCreate() {
    ...
    axios.get("https://www.mustavi.com/Trends/").then(res => {
      ...
      this.topic5 = res.data.data[0].Trends;
      this.topic6 = res.data.data[1].Trends;
      this.topic7 = res.data.data[2].Trends;
      this.topic8 = res.data.data[3].Trends;
      this.topic9 = res.data.data[4].Trends;
    ...
    axios.get("https://www.mustavi.com/ActiveTracking/").then(res => {
      this.toptrackTrends = res.data.data.slice(0, 10);

      this.breeds[10].name = this.breeds[10].key = res.data.data[0].Trend;
      this.breeds[11].name = this.breeds[11].key = res.data.data[1].Trend;
      this.breeds[12].name = this.breeds[12].key = res.data.data[2].Trend;
      this.breeds[13].name = this.breeds[13].key = res.data.data[3].Trend;
      this.breeds[14].name = this.breeds[14].key = res.data.data[4].Trend;

      this.breeds[15].name = this.breeds[15].key = res.data.data[5].Trend;
      this.breeds[16].name = this.breeds[16].key = res.data.data[6].Trend;
      this.breeds[17].name = this.breeds[17].key = res.data.data[7].Trend;
      this.breeds[18].name = this.breeds[18].key = res.data.data[8].Trend;
      this.breeds[19].name = this.breeds[19].key = res.data.data[9].Trend;
    });
  },
...
.card {
  background-color: rgb(49, 156, 189);
